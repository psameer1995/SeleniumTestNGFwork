...
public class myReadExcelDataIntoTC2 extends BaseTest{

	@Test(dataProviderClass=ReadXLSdata.class, dataProvider="myexceldata")
	public static void UserLoginTest(String username, String password) throws InterruptedException
